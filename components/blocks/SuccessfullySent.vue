<template>
<div data-aos="fade-up" class="transition duration-500 ease-in-out success ">
  <div class=" max-w-[982rem] text-center w-full py-[65px] rounded-[16px] bg-white mx-auto">
...
<!-- TODO:home ga otmayapti -->
    <nuxt-link to="/" class="inline-block  ml-auto text-white inter font-semibold text-[14px] leading-[20px] transition duration-300 ease-in-out hover:bg-[#2C61A6] bg-[#194D8F] rounded-[8px] py-[12px] px-[40px] outline-none">
      Tushunarli
    </nuxt-link>
  </div>
</div>
